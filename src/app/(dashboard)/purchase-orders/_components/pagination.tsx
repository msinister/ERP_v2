...
// URL-driven pagination. Mirrors the vendors / customers pagination
// components — owns ?skip=, reads take from the host, leaves all other
// params alone.
...
function countLabel(from: number, to: number, total: number): string {
  if (total === 0) return 'No purchase orders';
